...
# This function reads the input of an user to create a list of rows. This dictionary is then saved in the subdirectory /rooms as a .txt file. The user can switch to edit or delete after creation.
